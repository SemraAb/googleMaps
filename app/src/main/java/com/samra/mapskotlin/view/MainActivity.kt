...
import com.samra.mapskotlin.adapter.PlaceAdapter
import com.samra.mapskotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var db = Room.databaseBuilder(applicationContext , PlaceDatabase::class.java , "Places").build()
    ...
    private fun handlerResponse(placeList: List<Place>){
        ...
        var adapter = PlaceAdapter(placeList)
